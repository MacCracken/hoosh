...
- **Toolchain**: Cyrius (pinned in `cyrius.cyml`, currently 6.2.37)
- **Version**: SemVer 2.5.10 stable
...
**Note**: 17 LLM providers. Uses murti for local inference. OpenAI-compatible API.
