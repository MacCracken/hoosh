...
| | Rust | Cyrius | Ratio |
|---|------|--------|-------|
| Source | 22,956 lines / 58 files | ~12,600 lines / 34 files | **~1.8x fewer** |
...
```bash
# Run tests (834 assertions across 153 groups)
